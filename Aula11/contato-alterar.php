...
$sql = "select nome, email, mensagem,
        ...
        FROM contato where ID = ?"; //está faltando os campos email e mensagem erro 16
...
<div class="inicio">
    ...
    <div class="row">
        <div class="col-8 offset-2">
            <form class="row g-3" action="destino-contato-alterar.php" method="POST"> <!-- Erro no action, deve ser destino-contato-alterar.php erro 17 -->
