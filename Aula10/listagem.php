...
<div class="inicio">
    ...
    $count = $stmt->rowCount(); //faltando ; erro 9
            ...
            <table class="table table-striped ">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><?= $row['id'] ?></td> 
                            <td><?= $row['nome'] ?></td> <!-- erro na chave do array, remover espaço erro 10  -->
                            <td><?= $row['email'] ?></td> <!-- erro na chave do array, remover espaço erro 11  -->
                            <td><?= $row['mensagem'] ?></td>
                            ...
                            <td>
                                <a class="btn btn-sm btn-danger" 
                                    ...
                                    onclick="if(!confirm('Tem certeza que deseja excluir?')) return false;"> <!-- erro ao mostrar a variável id, está com a aberta do php errada erro 12 -->
